...
class TradingAccountLinkResponse(BaseModel):
    ...
    ingest_url: str = "https://analytica-backend-419965139801.us-central1.run.app/api/v1/ingest/mt5"
...
class TradingAccountLinkDirectResponse(BaseModel):
    account: TradingAccountSchema
    message: str = "Cuenta vinculada. La contraseña de inversor fue cifrada y almacenada de forma segura."
